...
if __name__ == "__main__":    
    ...
    #print("T(E,L)= {:.2e} *E/L+ {:.2e} *L + {:.2e}".format(fittedParameters[0],fittedParameters[1],fittedParameters[2]))
    #print("T(E,L)= {:.2e} *E+ {:.2e} *L + {:.2e}".format(fittedParameters[0],fittedParameters[1],fittedParameters[2]))
    print("T(E,L)= {:.2e} *E/L+ {:.2e} *E*L + {:.2e}".format(fittedParameters[0],fittedParameters[1],fittedParameters[2]))
    #print("T(Edges,Locales)=",fittedParameters[0],"*Edges/Locales+",fittedParameters[1],"*Locales+",fittedParameters[2])

    for i in range(1,5):
        print("T(E, {})= {:.2e} *E + {:.2e}".format(2**i, fittedParameters[0]/(2**i)+fittedParameters[1]*(2**i),fittedParameters[2]))
        #print("T(E, {})= {:.2e} *E + {:.2e}".format(2**i, fittedParameters[0]/(2**i)+fittedParameters[1]*(2**i),fittedParameters[2]))
