...
if __name__ == "__main__":
    ...
    for i in range(15,19):
            time_ak_bfs_graph(i,2,0.75,1,0)
    for i in range(15,19):
            time_ak_bfs_graph(i,2,0.75,0,0)

    '''
    for i in range(12,19,2):
            time_ak_bfs_graph(i,12,0.75,1,0)
    for i in range(12,19,2):
            time_ak_bfs_graph(i,12,0.75,0,0)
    for i in range(12,21,2):
            time_ak_bfs_graph(i,3,0.75,1,0)
    for i in range(12,21,2):
            time_ak_bfs_graph(i,3,0.75,0,0)
    ...
    for i in range(12,21,2):
            time_ak_bfs_graph(i,50,0.75,1,0)
    for i in range(12,21,2):
            time_ak_bfs_graph(i,50,0.75,0,0)
