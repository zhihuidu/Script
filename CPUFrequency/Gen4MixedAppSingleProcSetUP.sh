...
#		echo Test Frequency Combine : $Fre
		...
		do
			...
			then
				...
				echo "taskset -c $i   /home/zhihui/SPEC-CPU/spec2k6-v1.1/bin/runspec --config=Tong-linux.cfg  --nobuild --size=test --noreportable --iterations=$3 $4  &">>SetUp.sh
	#			echo "/home/zhihui/SPEC-CPU/spec2k6-v1.1/bin/runspec --config=Tong-linux.cfg --nobuild --size=test --noreportable --iterations=$3 $j  &">>SetUp.sh
			...
			if [ $branch -eq 1 ] 
			then
				echo "taskset -c $i   /home/zhihui/SPEC-CPU/spec2k6-v1.1/bin/runspec --config=Tong-linux.cfg  --nobuild --size=test --noreportable --iterations=$3 $5  &">>SetUp.sh
	#			echo "/home/zhihui/SPEC-CPU/spec2k6-v1.1/bin/runspec --config=Tong-linux.cfg --nobuild --size=test --noreportable --iterations=$3 $j  &">>SetUp.sh

			else
			if [ $branch -eq 2 ] 
			then
				echo "taskset -c $i   /home/zhihui/SPEC-CPU/spec2k6-v1.1/bin/runspec --config=Tong-linux.cfg  --nobuild --size=test --noreportable --iterations=$3 $6  &">>SetUp.sh
	#			echo "/home/zhihui/SPEC-CPU/spec2k6-v1.1/bin/runspec --config=Tong-linux.cfg --nobuild --size=test --noreportable --iterations=$3 $j  &">>SetUp.sh

			else
			if [ $branch -eq 3 ] 
			then
				echo "taskset -c $i   /home/zhihui/SPEC-CPU/spec2k6-v1.1/bin/runspec --config=Tong-linux.cfg  --nobuild --size=test --noreportable --iterations=$3 $7  &">>SetUp.sh
	#			echo "/home/zhihui/SPEC-CPU/spec2k6-v1.1/bin/runspec --config=Tong-linux.cfg --nobuild --size=test --noreportable --iterations=$3 $j  &">>SetUp.sh
