...
for k in  1600000 2000000 2400000 2800000 3200000 34000000 
do 
	for i in 0 1 2 3 
	do
...
#Initinalize all the cores to 3.4G
	for i in 0 1 2 3 
	do
		echo "echo 3400000 > /sys/devices/system/cpu/cpu$i/cpufreq/scaling_setspeed">>SetUp.sh
	done
...
#Change the frequency of P0
for k in 3400000 3200000 2800000 2400000 2000000 1600000
do 
	for i in 0 1 2 3 
	do
		echo "sleep 5">>SetUp.sh
