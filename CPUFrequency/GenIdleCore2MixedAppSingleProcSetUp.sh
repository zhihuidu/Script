...
#		echo Test Frequency Combine : $Fre
		...
		echo "taskset -c 6   /home/zhihui/SPEC-CPU/spec2k6-v1.1/bin/runspec $ExeParameters --iterations=$3 $4  &">>SetUp.sh
		echo "taskset -c 7   /home/zhihui/SPEC-CPU/spec2k6-v1.1/bin/runspec $ExeParameters --iterations=$3 $5  &">>SetUp.sh
		echo "taskset -c 14   /home/zhihui/SPEC-CPU/spec2k6-v1.1/bin/runspec $ExeParameters --iterations=$3 $4  &">>SetUp.sh
		echo "taskset -c 15   /home/zhihui/SPEC-CPU/spec2k6-v1.1/bin/runspec $ExeParameters --iterations=$3 $5  ">>SetUp.sh
