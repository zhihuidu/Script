...
#		echo Test Frequency Combine : $Fre
		...
		do
			...
			then
				...
				echo "taskset -c $i   /home/zhihui/SPEC-CPU/spec2k6-v1.1/bin/runspec $ExeParameters --iterations=$3 $4  &">>SetUp.sh
			else
				echo "taskset -c $i   /home/zhihui/SPEC-CPU/spec2k6-v1.1/bin/runspec $ExeParameters --iterations=$3 $5  &">>SetUp.sh
