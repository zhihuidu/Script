...
def time_ak_bfs_graph(trials:int,fn:int):
    ...
    directed=0
    weighted=0
    filename="rgg_n_2_"+str(fn)+"_s0"
    f = open("../../arkouda/data/rgg_n_2/"+filename+"/"+filename+".mtx")
    Line = f.readline()
    ...
    start = time.time()
    Graph=ak.graph_file_read(edges,vertices,2,directed,"../arkouda/data/rgg_n_2/"+filename+"/"+filename+".gr")
